...
class Collision_GT_rate_indep(evaluation_template):
    r'''
    ...
    def evaluate_prediction_method(self):
        ...
        # Overwrite Path_pred with Path_true (we compare against GT)
        Path_pred[...] = Path_true[...]
    ...
    def get_name(self = None):
        names = {'print': 'Collision rate (independent GT)',
                 'file': 'CR_GT_indep',
                 'latex': r'\emph{CR$_{indep,GT}$ [m]}'}
        return names
